<template>
    <div>
        ...
        <div class="headerTop">
            ...
            <div class="headerTop_text">归还申请</div>
        </div>
        <el-card>
            <el-row>
                <span class="headerTop_title">归还申请</span>
            ...
            <el-form>
                <el-row>
                    <el-col :span="3" style="text-align: right">归还单：</el-col>
                    <el-col :span="9">
                        <el-input placeholder="请输入内容" style="width: 250px"></el-input>
                    </el-col>
                    <el-col :span="3" style="text-align: right">归还类型：
                    </el-col>
                    <el-col :span="3">
                ...
                <el-row style="padding-top: 20px;">
                    <el-col :span="3" style="text-align: right">归还部门：</el-col>
                    <el-col :span="9">
                        <el-input placeholder="请输入内容" style="width: 250px"></el-input>
                    </el-col>
                    <el-col :span="3" style="text-align: right">归还人：</el-col>
                    <el-col :span="9" style="right: 0">
                        <el-input placeholder="请输入内容" style="width: 250px"></el-input>
                    </el-col>
                </el-row>
                <el-row style="padding-top: 20px;">
                    <el-col :span="3" style="text-align: right"><div  class="demo-input-suffix">归还原因：</div></el-col>
                    <el-col :span="21"><div  class="demo-input-suffix"><el-input placeholder="请输入内容" style="width: 90%"></el-input></div></el-col>
                </el-row>
            </el-form>
        </el-card>
        <el-card>
