<template>
    <div>
        ...
        <div class="headerTop">
            ...
            <div class="headerTop_text">延期申请</div>
        </div>
        <el-card>
            <el-row>
                <span class="headerTop_title">延期申请</span>
            ...
            <el-form>
                <el-row>
                    <el-col :span="3" style="text-align: right">延期单号：
                    </el-col>
                    <el-col :span="9">
                        <el-input placeholder="请输入内容" style="width: 250px"></el-input>
                    </el-col>
                    <el-col :span="3" style="text-align: right">预计延期日期：
                    </el-col>
                    <el-col :span="9">
                        <el-date-picker
                                v-model="value1"
                                type="datetime"
                                placeholder="请选择预计延期时间"
                                style="width: 250px">
                        </el-date-picker>
                    </el-col>
                ...
                <el-row style="padding-top: 20px;">
                    <el-col :span="3" style="text-align: right">申请部门：</el-col>
                    <el-col :span="9">
                        <el-input placeholder="请输入内容" style="width: 250px"></el-input>
                    </el-col>
                    <el-col :span="3" style="text-align: right">申请人：
                    </el-col>
                    <el-col :span="9">
                        <el-input placeholder="请输入内容" style="width: 250px"></el-input>
                    </el-col>
                ...
                <el-row style="padding-top: 20px;">
                    <el-col :span="3" style="text-align: right">
                        <div class="demo-input-suffix">挂失说明：</div>
                    </el-col>
                    <el-col :span="21">
        ...
        <el-card>
            ...
            >
                ...
                <el-table-column :resizable="false" prop="name" label="样本名称" width="200"
                                 align="center"></el-table-column>
                <el-table-column :resizable="false" prop="patientname" label="所属物种" width="200"
                                 align="center"></el-table-column>
                <el-table-column :resizable="false" prop="type" label="所属项目" width="200"
                                 align="center"></el-table-column>
                <el-table-column :resizable="false" prop="grass" label="样本类型" width="200"
                                 align="center"></el-table-column>
                <el-table-column :resizable="false" prop="tissuestype" label="组织类型" width="200"
                                 align="center"></el-table-column>
                <el-table-column :resizable="false" prop="diseasetype" label="肿瘤类型" width="200"
                                 align="center"></el-table-column>
                <el-table-column :resizable="false" prop="losssize" label="剩余容量" width="200"
                                 align="center"></el-table-column>
                <el-table-column :resizable="false" prop="losssize" label="融冻次数" width="200"
                                 align="center"></el-table-column>
            ...
            <!-- 添加样本 -->
            <el-dialog :close-on-click-modal="false" :title="addForm.id ? '编辑样本' : '新增样本'"
                       :visible.sync="addDialogVisible" width="40%" @close="addDialogClosed">
                <el-form :model="addForm" :rules="addFormRules" ref="addFormRef" label-width="100px">
                    ...
                    <el-form-item label="种属">
                        <el-select v-model="addForm.grassid" filterable placeholder="请选择种属">
                            <el-option v-for="item in grassList" :key="item.id" :label="item.name"
                                       :value="item.id"></el-option>
                        </el-select>
                    </el-form-item>
                    <el-form-item label="组织类型">
                        <el-select v-model="addForm.tissuestypeid" filterable placeholder="请选择组织类型">
                            <el-option v-for="item in tissuestypeList" :key="item.id" :label="item.name"
                                       :value="item.id"></el-option>
                        </el-select>
                    </el-form-item>
                    <el-form-item label="肿瘤类型">
                        <el-select v-model="addForm.diseasetypeid" filterable placeholder="请选择肿瘤类型">
                            <el-option v-for="item in diseasetypeList" :key="item.key" :label="item.name"
