<template>
    <div>
        ...
        <div class="headerTop">
            ...
            <div class="headerTop_text">过期销毁申请</div>
        </div>
        <el-card>
            <el-row>
                <span class="headerTop_title">过期销毁申请</span>
            ...
            <el-form>
                ...
                <el-row style="padding-top: 20px;">
                    <el-col :span="12" style="right: 0">申请部门：
                        <el-input placeholder="请输入内容" style="width: 250px"></el-input>
                    </el-col>
                    <el-col :span="12" style="right: 0">申请人：
                        <el-input placeholder="请输入内容" style="width: 250px"></el-input>
                    </el-col>
                </el-row>
                <el-row style="padding-top: 20px;">
                    <el-col :span="24">
                        <div class="demo-input-suffix">申请说明：
                            <el-input placeholder="请输入内容" style="width: 90%"></el-input>
                        </div>
                    </el-col>
                </el-row>
